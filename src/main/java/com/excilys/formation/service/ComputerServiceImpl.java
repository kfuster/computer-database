...
public class ComputerServiceImpl implements ComputerService{
    ...
    public ComputerDto create(ComputerDto pComputerDto) {
        try {
        	Computer computer = new Computer.ComputerBuilder(pComputerDto.name)
        			.setDateDisc(pComputerDto.discontinued)
    ...
    private List<Computer> DtoListToComputerList(List<ComputerDto> pListDto) {
    	...
    	if(pListDto != null) {
    		...
    		for(ComputerDto computer : pListDto) {
    			...
    			computers.add(new Computer.ComputerBuilder(computer.name)
    					.setCompany(company)
    					.setDateIntro(computer.introduced)
    					.setDateDisc(computer.discontinued)
    					.setId(computer.id)
    					.build());
    		}
    	}
