...
public class AddChangeLanguageIT {
  ...
  @Test
  public void testAddChangeLanguageIT() throws Exception {
    ...
    Thread.sleep(SLEEP);
    assertEquals(driver.findElement(By.xpath("//h1")).getText(), "Ajouter un ordinateur");
