...
public class EditChangeLanguageIT {
  ...
  @Test
  public void testEditChangeLanguageIT() throws Exception {
    ...
    Thread.sleep(SLEEP);
    assertTrue(driver.findElement(By.xpath("//h1")).getText().endsWith("Edit Computer"));

    driver.findElement(By.xpath("//img[@onclick=\"$.fn.changeLanguage('fr')\"]")).click();
    Thread.sleep(SLEEP);
    assertTrue(driver.findElement(By.xpath("//h1")).getText().endsWith("Editer l'ordinateur"));
